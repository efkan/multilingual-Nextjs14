...
import { MonsterMuiTheme } from '@monster-notebook/mui'
      ...
      <main className="flex min-h-screen flex-col items-center justify-between p-24">
        <div className="z-10 max-w-5xl w-full items-start justify-between font-mono text-sm lg:flex">
          <div className='flex gap-y-3 flex-col justify-center'>
            <p className="fixed left-0 top-0 flex w-full justify-start border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl border-neutral-800 bg-zinc-800/30 from-inherit lg:static lg:w-auto  lg:rounded-xl lg:border lg:p-4 lg:bg-zinc-800/30">
              {t.Country}&nbsp;
              <code className="font-mono font-bold">{params.locale}</code>
            </p>
            <p className="fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl border-neutral-800 bg-zinc-800/30 from-inherit lg:static lg:w-auto  lg:rounded-xl lg:border lg:p-4 lg:bg-zinc-800/30">
              {t.SelectedLocale}&nbsp;
              <code className="font-mono font-bold">{params.locale}</code>
            </p>
          </div>
